...
ActiveRecord::Schema.define(version: 2022_02_18_165613) do
  ...
  create_table "event_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["event_post_id"], name: "index_event_comments_on_event_post_id"
  ...
  add_foreign_key "event_comments", "event_posts"
